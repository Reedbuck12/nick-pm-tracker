...
A polished, demoable AI-assisted project management tracker for PMs — tracking tasks, deliverables, risks, issues, and owners, with AI-generated summaries and risk scoring.
...
- **Commit as your GitHub identity, or Vercel will block the deploy.** Vercel verifies that
  ...
  ```
  git config user.email "302204857+Reedbuck12@users.noreply.github.com"
  git config user.name "Reedbuck12"
  ```
